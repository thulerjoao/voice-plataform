...
func main() {
	...
	mux.HandleFunc("GET /ws", realtime.HandleWS(store, hub, presence))
	...
	mux.HandleFunc("DELETE /api/rooms/{id}/channels/{channelId}", rooms.HandleDeleteChannel(store, hub, presence))
	mux.HandleFunc("POST /api/rooms/{id}/members/{memberUid}/role", rooms.HandleSetRole(store, hub, presence))
	mux.HandleFunc("POST /api/rooms/{id}/members/{memberUid}/kick", rooms.HandleKick(store, hub, presence))
	mux.HandleFunc("POST /api/rooms/{id}/blocked", rooms.HandleBlock(store, hub, presence))
